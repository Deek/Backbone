...
*/
#ifndef PA_M_Time_BBClassicAnalog_h
#define PA_M_Time_BBClassicAnalog_h

#include "BBClockView.h"

@interface BBClassicAnalog: NSObject <BBClockDelegate>
{
	id		clock;
	NSImage	*mask;
...
#endif	// PA_M_Time_BBClassicAnalog_h
