...
{
	IBOutlet NSPopUpButton	*firstAlternatePopUp;
	IBOutlet NSPopUpButton	*firstCommandPopUp;
	IBOutlet NSPopUpButton	*firstControlPopUp;
	IBOutlet NSPopUpButton	*secondAlternatePopUp;
	IBOutlet NSPopUpButton	*secondCommandPopUp;
	IBOutlet NSPopUpButton	*secondControlPopUp;
